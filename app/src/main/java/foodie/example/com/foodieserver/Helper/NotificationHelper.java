...
public class NotificationHelper extends ContextWrapper {
    private static final String PBU_CHANNEL_ID = "foodie.example.com.foodieserver.PBU";
    private static final String BPU_CHANNEL_NAME = "PBU Wallet";
    ...
    private void createChannel() {
        NotificationChannel utpchannel = new NotificationChannel(PBU_CHANNEL_ID,
                BPU_CHANNEL_NAME,
    ...
    public android.app.Notification.Builder getFoodieChannelNotification(String title, String body, PendingIntent contentIntent,
                                                                         Uri soundUri){
        return new android.app.Notification.Builder(getApplicationContext(),PBU_CHANNEL_ID)
